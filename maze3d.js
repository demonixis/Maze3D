(function() {
    ...
    function initializeEngine() {
        ...
        textures[0] = THREE.ImageUtils.loadTexture("assets/images/textures/tarmac02.jpg");
    ...
    function initializeScene() {
        ...
        var sol = new THREE.Mesh(new THREE.CubeGeometry(plateformeSize.width, 5, plateformeSize.height), new THREE.MeshPhongMaterial({
            map: textures[0]
        }));
        sol.overdraw = true;
        ...
        var plafond = new THREE.Mesh(new THREE.CubeGeometry(plateformeSize.width, 5, plateformeSize.height), new THREE.MeshPhongMaterial({
            map: textures[1]
        }));
